.PHONY: all mud backends libraries examples tests install clean help

all: mud backends libraries
...
help:
	...
	@echo "make libraries \t - Builds the shared library files for every Mud library"
	...
	@echo "make install   \t - Installs the Mud shared library to the system"
