...
#define MUDSDLBACKEND_VERSION_STRING (TO_STRING(MUDSDLBACKEND_VERSION_MAJOR) "." TO_STRING(MUDSDLBACKEND_VERSION_MINOR) "." TO_STRING(MUDSDLBACKEND_VERSION_PATCH))
 ...
 * @return MudSDLBackend_FontData* The data parameter or a heap allocated pointer if data was NULL 
 */
MUD_API MudSDLBackend_FontData* MudSDLBackend_openFontData(MudSDLBackend_FontData* data, const char* fontPath, float pointSize, TextType textType);
 ...
 * @param freeAfterRendering If the texture should be freed after being rendered.
 * @return MudSDLBackend_TextureData* The data parameter or a heap allocated pointer if data was NULL
 */
MUD_API MudSDLBackend_TextureData* MudSDLBackend_createTexture(MudSDLBackend_TextureData* data, const char* filename, bool freeAfterRendering);
 ...
 */
MUD_API void MudSDLBackend_destroyTexture(MudSDLBackend_TextureData* textureData);

/**
 * @brief Returns the SDL_Window pointer associated to this application.
 * If you want to get the rendering context associated to this window please use SDL_GetRenderer
 *
 ...
 * 
 * @return MUD_API const* The Mud SDL backend version string formatted in "major.minor.patch"
 */
